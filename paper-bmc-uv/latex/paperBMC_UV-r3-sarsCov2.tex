...
\begin{figure}[th]
\includegraphics[bb=0bp 0bp 224bp 127bp]{images/1_trajectory-description-2RN2-pdbs}
...
\begin{figure}[th]
\includegraphics[bb=0bp 0bp 210bp 104bp,scale=1.05]{images/2_2RN2-trajectory-weakness}
...
\begin{figure}[th]
\includegraphics[scale=1.2]{images/3_algorithm-description-general}
...
\begin{figure}[th]
\begin{centering}
\includegraphics{images/4_algorithm-description-parallel}
\par\end{centering}
\caption{\csentence{Parallel processing of segments.} The trajectory is divided into $m$ segments ($S_{1}$, ..., $S_{m}$), and each segment is processed separately and in parallel on a machine with n processing cores. The results of the extraction and selection steps ($S\lyxmathsym{’}_{1}$, ..., $S\lyxmathsym{’}_{m}$) are independent of each other and are joined to form the reduced trajectory.\label{fig:Algorithm-Parallel}}
\end{figure}
...
\begin{figure*}[!t]
\begin{centering}
\includegraphics{images/5_path-comparisons}
\par\end{centering}
...
\begin{figure}[!th]
\begin{centering}
\includegraphics{images/6_paths-intrinsic-info}
\par\end{centering}
...
\begin{figure}[th]
\begin{centering}
\includegraphics{images/7_performance-times}
\par\end{centering}
