...
pdf (pdfFilename, width=10, height=7)
	...
	colorsLegend = c("green", "magenta", "red", "black", "blue")
	textsLegend  = c("nMDS", "Clustering", "PCA", "FR1 (1 core)", "FR2 (2 cores)")
	pchsLegend   = c(21, 20,19, 15, 16)
	legend (x="topright", xpd=T, inset = c(-0.45,0), title="Reduction Methods", textsLegend,
			col=colorsLegend, pch=pchsLegend, lty=c(1,1,1,1,1), cex=CEX)

	text (x=8000, y=240, "nMDS", col="green", cex=CEX)
	text (x=42000, y=240, "Clustering", col="magenta", cex=CEX)
	text (x=92000, y=240, "FR1", cex=CEX)
	text (x=98000, y=165, "PCA", col="red", cex=CEX)
	text (x=99000, y=130, "FR2", col="blue", cex=CEX)
