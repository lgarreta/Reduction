...
**************************************************************************
      ...
      subroutine getTMscore (pdb1, pdb2, resTMscore)
      character*500 pdb1, pdb2
...
********* read the structure1--------->      
      ...
      i=1
 100  read(10,103,IOSTAT=io)du,n1(i),du,x1(i),y1(i),z1(i)
      if (io < 0) goto 101
      i=i+1
      goto 100
 101  close(10)
...
********* read the structure2--------->      
      ...
      i=1
 102  read(10,103, IOSTAT=io)du,n2(i),du,x2(i),y2(i),z2(i)
      if (io < 0) goto 104
      i=i+1
      goto 102
 104  close(10)
...
*     do i=1,L1
*        write(*,*)">>L1:",i,n1(i),x1(i),y1(i),z1(i)
*     enddo
*     do i=1,L2
*        write(*,*)">>L2:",i,n2(i),x2(i),y2(i),z2(i)
*     enddo
*      write(*,*)TM
