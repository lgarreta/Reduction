...
main <- function () {
	...
	writeClusteringResults_local_reductions (clusteringResults, dirPdbs)
	
}

#----------------------------------------------------------
# Paralle local reduction (see reduceLocal)
#----------------------------------------------------------
...
#----------------------------------------------------------
writeClusteringResults_local_reductions <- function (clusteringResults, outputDir) {
	listOfPDBs = c ()
